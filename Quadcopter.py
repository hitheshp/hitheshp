...
import hand_gesture_detection.py
...
def movement(clientID,direction):
    ...
    direction = hand_gesture_detection.className
    #  Collect events until released
    initial_position = target_position
    prev_direction = ""
    
    if direction == "fist" and prev_direction != "fist":
         flag = True
         prev_direction = "fist"
         while flag:
    ...
    elif direction == "peace" and prev_direction != "peace":
        [returnCode, target_position] = vrep.simxGetObjectPosition(clientID, targetObj,-1,vrep.simx_opmode_blocking)
        flag = True
        prev_direction = "peace"
        while flag:
